...
namespace Sovva.Infrastructure.Migrations
{
    ...
    [Migration("20260625175621_AddScheduledOrderIdIndex")]
    partial class AddScheduledOrderIdIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sovva.Domain.Entities.FailedOrderAttempt", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Sovva.Domain.Entities.ScheduledOrder", b =>
                {
                    ...
                    b.HasIndex("ScheduledFor", "IsProcessedToOrder")
                    ...
                    b.ToTable("Subscriptions", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_Subscriptions_AgreedPrice", "\"AgreedPrice\" > 0");
            ...
            modelBuilder.Entity("Sovva.Domain.Entities.WalletTransaction", b =>
                {
                    ...
                    NpgsqlIndexBuilderExtensions.IncludeProperties(b.HasIndex("UserId", "Type"), new[] { "Amount", "CreatedAt" });
