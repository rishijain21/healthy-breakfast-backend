...
namespace Sovva.Application.Interfaces
{
    public interface IScheduledOrderService
    {
        ...
        Task<ProcessOrdersResponseDto> RetryFailedOrdersAsync(DateOnly? targetDate = null, string? correlationId = null);
        Task<bool> ProcessSingleScheduledOrderAsync(
            Sovva.Domain.Entities.ScheduledOrder scheduledOrder,
            IReadOnlyDictionary<Guid, Sovva.Domain.Entities.User> usersByAuthId,
            IReadOnlyDictionary<int, Sovva.Domain.Entities.Order> existingOrders,
            IReadOnlyDictionary<int, Sovva.Domain.Entities.WalletTransaction> existingTransactions,
            IReadOnlyDictionary<int, Sovva.Domain.Entities.UserAddress> addressesMap);
